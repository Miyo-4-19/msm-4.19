deps_config := \
	...
	drivers/misc/carillon/Kconfig \
	drivers/misc/pn553/Kconfig \
...
ifneq "$(CC_VERSION_TEXT)" "Neutron clang version 19.0.0git (https://github.com/llvm/llvm-project.git fd3eaf76ba3392a4406247d996e757ef49f7a8b2)"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ld.lld"
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-gnu- --gcc-toolchain=/usr -no-integrated-as -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
